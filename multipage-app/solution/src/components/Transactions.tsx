...
const Transactions: React.FC = () => {
  ...
  const shouldEnableSubmitButton = () => {
    /* Task 2 */
    return transaction.name !== "" && transaction.amount > 0;
  };
        ...
        <div className="max-w-3xl flex flex-col bg-gray-50 p-6 my-4">
          ...
          <div className="flex justify-end gap-5">
            <button
              ...
              className="px-4 py-1 border rounded border-black bg-white hover:bg-gray-100 text-black"
            >
              Cancel
            </button>
            <button
